  ...
  return (
    <RepositoryFrame>
      ...
      {view === "assurance" ? (
        ...
        <><ResponsePolicies repository={repository.id} actor={actor} /><ResponseRotations repository={repository.id} actor={actor} /><ResponseAlerts repository={repository.id} actor={actor} /></>
      ) : view === "accessibility" ? (
