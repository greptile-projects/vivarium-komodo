...
type Incident = { id:string; repository_id:string; title:string; summary:string; severity:"critical"|"high"|"medium"|"low"; status:"declared"|"investigating"|"mitigating"|"monitoring"|"resolved"; declared_by_id:string; roles:Record<string,string>; affected:Array<{repository_id:string;environment_id:string}>; source_signal?:{deployment_id:string;event_sequence:number;stage?:string;signal?:string;outcome?:string}; followers:string[]; acknowledgements:Array<{actor_id:string;update_sequence:number;created_at:string}>; evidence:IncidentEvidence[]; findings:IncidentFinding[]; mitigations:IncidentMitigation[]; timeline:IncidentEvent[]; created_at:string; updated_at:string };
