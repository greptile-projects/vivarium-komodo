...
export default function RepositoryPage({
  ...
  return (
    <RepositoryFrame>
      ...
      {view === "quality" ? (
        <><QualityPlans repository={repository.id} actor={actor} /><TestScenarios repository={repository.id} actor={actor} /><ExploratorySessions repository={repository.id} actor={actor} /></>
      ) : view === "governance" ? (
        ...
        <><AgentEvaluations repository={id} actor={actor} /><AgentDiscovery repository={id} actor={actor} /><AgentProfiles actor={actor} /></>
      ) : view === "funds" ? (
